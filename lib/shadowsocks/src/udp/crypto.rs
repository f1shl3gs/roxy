...
use crate::udp::aead2022::{decrypt_server_payload_aead_2022, encrypt_client_payload_aead_2022};
use crate::Address;
...
pub fn encrypt_client_payload(
    ...
    match kind.category() {
        ...
        CipherCategory::Aead2022 => {
            encrypt_client_payload_aead_2022(kind, key, addr, control, identity_keys, payload, dst)
        }
    }
}
...
pub async fn decrypt_server_payload(
    ...
    match kind.category() {
        CipherCategory::Aead => decrypt_payload_aead(kind, key, payload)
            ...
            .map(|(n, a)| (n, a, None))
            .map_err(Into::into),
        CipherCategory::Aead2022 => decrypt_server_payload_aead_2022(kind, key, payload)
            .await
